...
description: "Provider-neutral prompt engineering for LLM applications: structure, security, evaluation, and optimization."
---
...
It does NOT cover Codex customization files (explicit workflow skills in `.agents/skills/*/SKILL.md`, custom agents in `.codex/agents/*.toml`, supporting skills in `.agents/skills/<name>/SKILL.md`, or project guidance in `AGENTS.md`). Those belong to the `fabrico-creating-workflows`, `fabrico-creating-agents`, and `fabrico-creating-skills` skills.
</scope>
...
- `fabrico-creating-workflows` — for explicit Codex workflow skills (`.agents/skills/*/SKILL.md`) (different domain, complementary)
