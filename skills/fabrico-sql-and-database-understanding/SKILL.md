---
name: fabrico-sql-and-database-understanding
description: "Schema design, SQL, indexes, transactions, and ORM integration."
---
...
- `fabrico-architecture-designing` — for designing data models as part of broader system architecture
- `fabrico-code-reviewing` — for validating SQL quality, index coverage, and query performance
- `fabrico-technical-context-discovering` — for establishing database conventions and existing patterns before designing
