---
name: fabrico-codebase-analysing
description: "Analyze dependencies, business logic, structure, and duplication."
---
...
When this skill is invoked by another command or workflow that defines its own required output file/template, embed the relevant findings into that caller's required output instead of creating a separate codebase-analysis report, unless the user explicitly asks for one.
