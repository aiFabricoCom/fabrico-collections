---
name: fabrico-designing-multi-cloud-architecture
description: "Select and integrate services across AWS, Azure, and GCP."
---
...
6. **Implement IaC** → Use `fabrico-implementing-terraform-modules` skill
...
- `fabrico-implementing-terraform-modules` - For IaC implementation
- `fabrico-optimizing-cloud-cost` - For cost management
