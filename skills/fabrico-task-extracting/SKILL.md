...
- **PDF documents**: If available, read PDF files using file-reading tools to extract requirements, process descriptions, business rules, or any other relevant content provided by the client
