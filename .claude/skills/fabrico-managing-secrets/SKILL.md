...
Use the **context7** MCP server (tools `mcp__context7__*`) or cloud documentation MCP to look up provider-specific syntax.
...
3. **Look up implementation** → Use the **context7** MCP server (tools `mcp__context7__*`) or cloud MCP for current syntax
