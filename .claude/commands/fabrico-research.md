---
description: "Research a task based on the provided Jira ID or task description, producing a comprehensive research markdown file."
argument-hint: "[Jira ID or task description]"
---
...
5. Unless asked to research only non-frontend aspects, in case there are Figma designs linked to the task, review all of them using the **figma** MCP server (tools `mcp__figma__*`) (it's very important) and include relevant information in the context.
...
<!-- FABRICO_COLLECTIONS:command:fabrico-research:v1 -->
